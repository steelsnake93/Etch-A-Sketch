...
- create a web page with 16x16 grid of square divs using Javascript.
- set up "hover" effect so the grid divs change color when your mouse passes over them, leaving a (pixilated) trail through your grid like a pen would.
